...
pub fn validate_entry_create(entry: PTPromiseEntry, validation_data: hdk::ValidationData) -> Result<(), String> {
...
pub fn validate_entry_modify(new_entry: PTPromiseEntry, old_entry: PTPromiseEntry, old_entry_header: ChainHeader, validation_data: hdk::ValidationData) -> Result<(), String> {
...
pub fn validate_entry_delete(old_entry: PTPromiseEntry, old_entry_header: ChainHeader, validation_data: hdk::ValidationData) -> Result<(), String> {
